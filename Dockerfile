...
# hadoop
RUN curl http://mirrors.aliyun.com/apache/hadoop/common/hadoop-2.7.1/hadoop-2.7.1.tar.gz | tar -xz -C /usr/local/
...
RUN mkdir -p /usr/java && ln -s /opt/jdk /usr/java/default
